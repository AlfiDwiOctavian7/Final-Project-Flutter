...
class RegisterScreensGuru extends StatefulWidget {
  const RegisterScreensGuru({Key? key}) : super(key: key);

  static String routeName = "/sing_up";

  @override
  State<RegisterScreensGuru> createState() => _RegisterScreensGuruState();
}

class _RegisterScreensGuruState extends State<RegisterScreensGuru> {
